        ...
        this.state={
            items: [
                ...
                },
                {
                    ...
                    subTitle: 'A PHP Project which helped Indian Railways, Mumbai(IN) to digitally allot residence to government officials. This came as a big relief from the manual process',
                    imgSrc: train,
